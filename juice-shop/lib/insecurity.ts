...
// FIX V4 (CWE-798): private key loaded from a file excluded from version control
// (encryptionkeys/jwt.key, see .gitignore) instead of hardcoded in source — rotated to a
// freshly generated keypair so any previously leaked signing key is no longer valid. See
